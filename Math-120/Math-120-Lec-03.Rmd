...
## Conclusions about Emprical Rule

Empirical rule lets us make predictions about where we expect data to lie (only in a normal dist).  

Empricial rule lets you have feelings about z scores!  We know how common/uncommon a particular measurement is!
...
In reality, we're forced to work with samples.  We hope they're representive, i.e., the sample statistic is the similar to the population parameter.  We have to balance these two "levels" of our data:
...
- population proprtion is "p" (unusual latin instead of greek)

We'll never know these parameters, but we hope to say something smart about them based on our statistis (i.e. our sample data).  This process is called **statistical inference**:  making conclusions about population parameters based on sample statistics.

## 4 Sampling Strategies

(Note:  reading in 1.3 of your text)

Note:  the population in question is up to YOU to determine!  Ex:  all americans, all university studetns, all men.  
