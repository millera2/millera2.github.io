...
**Continuous**:  Can take any value on the real line.  Usually, these are phyiscal measurements:  height, length, duration, volume, etc etc.  Infinite decimals.   Example, height:  someone could be 5'6",  someone could 5'7", and there are an infinite number or possibilities between.  
...
- "Year" is ordinal.  Even though they're numbers, just a label.  Like month or day of the week.  It is a little blury!  In some sense, simialar to discrete.  
...
Always first:  visualize!!!  Warning:  the options for visualization depend on the type data!

## Quantitative visualzation:  histograms
