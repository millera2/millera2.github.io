...
2) For each sample in step 1, construct both a 50% CI and a 95% of the proportion of respondants affiliated with one political party (you can choose either Democrat or Republicans; it doesn't matter since there's only two options).  Interpret each interval with a short sentence.  
    ...
    How do the 50% intervals compare with the 90% intervals?  Are you surprised?
