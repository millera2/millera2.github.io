...
Geometric, p=.072, need P(X=14)

```{r}
#note:  in R, use # of failures (13) not # trials (14)
...
Poisson, lambda = 6/10*2 = 12/10.  Need P(X>=1), thus 1-P(X=0)
...
Binomial, n=8, p=0.42.  Need P(X>=6) = P(X=6)+P(X=7)+P(X=8)

```{r}
dbinom(6,8,.42)+dbinom(7,8,.42)+dbinom(8,8,.42)
```
...
None of the distros work, since probability of success changes.  Need p constant.
...
Geometric, p=.052.  Need P(X>=4) = 1-P(X=1)-P(X=2)-P(X=3)

```{r}
1-dgeom(0,.052)-dgeom(1, .052)-dgeom(2, .052)
```
