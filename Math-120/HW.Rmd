...
**For each answer, give the number answer first, followed by a brief explanation with a comlete sentence or two.**
...
4)  If we know that a prisoner was exectued in the South, what's the probability that they died in a Gas Chamber?
