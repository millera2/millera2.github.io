...
**Lecture Coverage: ** 23-26 (they're each pretty short)

- What's a hyp test?  What do we use them for?
- How to hyp tests compare with CIs as a tool for inference?
- What are the four key steps of a hyp test?
- How to the hypotheses work?  H0?  Ha?
- How is a test stat computed?
- How is a p-val computed?
- How do we make conclusions in a hyp test?
- What's the significance level of a test?
- What's the difference between a left-tail test, right-tail test, and two-tail test?

## Labs

- [Lab 6](https://millera2.github.io/Math-120/Math-120-Lab-6.html)
- [Lab 5](https://millera2.github.io/Math-120/Math-120-Lab-5.html)
