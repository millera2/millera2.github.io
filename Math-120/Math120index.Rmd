...
Topics:
- interpreting slope and intercept of regression line in context of model
- interpreting residual plot, understanding key features, support (or not) for linear model
- understanding coefficient of determination, explaining in context
...
- 8.21 (p325)
- 8.23c (p326)
- 8.25bcd (p237) (Here, slope = 2.559 and intercept = -29.901)
...
Next HW due:  Sept 18 by 5pm on Notebowl.  File format: .pdf document.
