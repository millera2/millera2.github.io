...
**Lecture Coverage: ** 20, 21, 22

- What is a sampling distro?  Why do we need them?
- How did Lab 4, Part II connect to sampling distros?
- How did we compute one explicitly for the dice distro with n=2?
- What does the central limit theorem say?
- What are the center and spread for the distro for $\hat{p}$?
- How can we use `pnorm()` to compute probabilities for sample results?
