...
- Students can still earn a max of 75/100 if they implement the code for `makeSquare` and `makeTriangle` without errors, according to the specifications.  This assumes that students have also implemented a `main()` function as described above.
...
- If students add any extra bells and whistles (beyond the full specifications of the assignment), they'll additionally earn Prof. Miller's respect.  It's a very valuable commodity.  ;D
