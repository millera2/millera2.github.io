...
- To earn a C, students must at least implement the `makeSquare`, `makeTriangle`, and `main` functions  without errors and according to the specifications, along with the docstring.  
- If, in addition, students can implement any ONE of the `spread`, `zoom`, or `slide` functions, then they can earn a B.
