...
Lecture Coverage:  Week 4

Book coverage: Section 3.1-3.4

Key Skills:  ADTs, classes vs objects, functional abstraction, default parameter values, docstrings, `main()` function.
