...
Topics:  Disjoint events, general addition rule, "at least one" problems, independent events, multiplication rule for independent events, checking for independence (and justifying mathematically), conditional probaability
...
- 3.14 (p109)
- 3.15 (p109)
- In the table below about game night preferen es:  Are the events "poker" and "cookies" independent?
