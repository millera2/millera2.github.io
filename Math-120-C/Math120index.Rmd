...
- Binomial Distribution, Geometric Distribution
  - Properties/Criteria/Requirements
  - Definition
  - Calculation
  - Expected Value/Variance/Stdev
- Expected Value, Variance, and Stdev for all the above distributions
  - Sketch 
  - Compute
...
- 4.12, 4.13 (p148)
- 4.17, 4.19, 4.23 (p156-157)
- Example 5.3.5 on [this page](https://stats.libretexts.org/Bookshelves/Introductory_Statistics/Book%3A_Introductory_Statistics_(OpenStax)/05%3A_Continuous_Random_Variables/5.03%3A_The_Uniform_Distribution) (scroll about halfway down.  Solution included.  Other examples are good.)
