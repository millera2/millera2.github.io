...
Topics:  Continuous distributions, uniform distribution, normal distribution, z-table

Practice Problems:

- 4.1 (p142)
- 4.3 (a-g only) (p142)
- What's the cutoff for the upper 15% of the z dist? (<small><i>Answer (don't look yet!): 1.04</i></small>)
- The amount of time it takes Prof Miller to walk to school varies uniformly between 8 and 10 minutes.  Sketch the distribution, and compute the probabaility that it takes her at least 8.5 minutes.  (<small><i>Answer(don't look yet!): 75% </i></small>)
