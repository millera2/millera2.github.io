...
Reading:  4.1, class notes

Topics:  Normal dist (practical scenarios), forwards/backwards problems, sampling distributions, Central Limit Theorem, "large enough"
...
e)  For which of the above (a-d) did we need to know in advance that finish times follow a normal distribution?
    ...
    Answers (Stop looking!!!):  a) .6006   b)  8.18 min   c) .1030  d) 14.506  e) All except d
