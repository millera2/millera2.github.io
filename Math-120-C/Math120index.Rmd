...
This one's for real.  **Be sure you have access to a working computer.**  Make sure you can log into Notebowl.  Have a backup if you're worried (library, computer lab, etc).  

If Notebowl freezes up during the quiz, **REFRESH THE PAGE IMMEDIATELY**.  I promise you won't lose any work!

Reading: Texbook 1.2 and 2.1

Topics:

- Syllabus
- Rectangular Data
- Types of Data, identifying which is which
- Metadata
...
**Note that solutions for odd problems are in the back of the book.** See table of contents to find them.

I don't post solutions to evens -- visit office hours if you have questions.
