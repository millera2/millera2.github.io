...
Topics:  Hyp Tests and CIs!  

- Hyp tests for mu, p, mu1-mu2, p1-p2, rho, GOF, Independence
- CIs for mu, p, mu1-mu2, p1-p2
- Error Types
- Critical values
- P-values
- Significance level
- Planning for sample size
- Connection btwn CI and Hyp Test

Practice Problems (**in order of importance**):

- **Old Quiz Questions!**  Specifically:  Q9-Q13
- **Old Practice Problems!** Specifically:  Week 9 - 13

Practice for test for rho:

- In a dataset on length and weight of 14 rats, we calculate a correlation of 0.53.  Does this provide strong evidence of a linear relationship between length and weight?  <small>(Partial solutions: t=2.165, .05<p-val<.1)
