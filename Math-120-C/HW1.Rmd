...
Due:  **Mon April 18 on Notebowl by 10pm.**
...
f)  Suppose we are testing to see if more than half of students support a change to the Student Handbook.  In our sample of 100 students, 54 support the change.  Compute the exact p-value for the hyp test.
...
Due Monday April 4th on Notebowl by 10pm.  Submit .pdf report as usual.
...
Due Friday Wed March 23 on Notebowlby 10pm.  Submit as .pdf document per the usual.

In this HW you'll be investigating a [dataset](https://docs.google.com/spreadsheets/d/186B4a99Nnf8FWDeoqdnnRvWJxrRYcbTHJ6AoKBKnXE4/edit?usp=sharing) that catalogs details about 890 passengers of the historic Titanic maiden voyage (about 1/3 of the total).
