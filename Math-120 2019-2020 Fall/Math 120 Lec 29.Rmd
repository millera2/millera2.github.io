...
For hyp tets, the test stat is:

$$t = \frac{\bar{x_1}-\bar{x_2}}{\sqrt{\frac{s_1^2}{n_1}+\frac{s_2^2}{n_2}}}$$
The formula for the df is complicated.  If workign by hand, you can just use the smaller of $n_1$ and $n_2$.  If using the `t.test` function in r, you can see the exact df.

For CIs, the formula for the interval is 
...
Since our p-val is less than .05, we reject H0.  There's evidence of a difference in mean.
